        ...
        "content": [
          ...
          },
          {
            ...
            "items": [
              {
                "type": "text",
                "content": "意思決定に関する近年の研究で，人間の決定は「真空」状態でおこなわれるわけではないことがわかってきました。人が何かを決めるとき，その人の好みや知識，または，そのときどんな状況におかれているかなどのさまざまな特徴が，大きな影響を及ぼすのです。この調査では，こうした「人間の決め方」を研究するために、あなたの「意思決定者」としてのある特徴を知りたいと考えています。つまり，あなたがこの指示を時間をかけてよく読んでいるかどうかを知りたいのです。もし誰もこの問題文をお読みになっていなければ，問題文の内容を内容を変えることが「人間の決め方」に与える影響を見たい，というわれわれの試みは意味を持たないからです。ここからがお願いです。この指示をお読みになったことの証明として，以下のスポーツ競技に関する項目はすべて無視してください。その代わり，「その他」にチェックを入れた上で，自由記述欄に　読んだ　と入力し，次に進んでください。よろしくお願いします。"
              },
              {
                "required": false,
                "type": "checkbox",
                "label": "普段よく行う活動は以下のうちどれですか。当てはまるもの全てにチェックを入れてください。",
                "options": [
                  {
                    "label": "スキー",
                    "coding": "0"
                    ...
                    "items": [
                      {
                        "required": true,
                        "type": "text",
                        "title": "この質問には回答しないでください。過去のあなたについての質問をします。13歳～17歳のことを思い出して回答してください。",
                        "content": "あなたに不利益を被ることはありません、率直にご回答ください。\n※１度「次へ進む」を押すと、戻ることはできません。回答が無効になるため、ブラウザの戻るボタンを使用しないでください。"
                      },
                      {
                        "required": false,
                        "type": "radio",
                        "label": "あなたが13～17歳の間、あなたはよくゲームをしていましたか？",
                        "options": [
                          {
                            "label": "全くあてはまらない",
                            "coding": "0"
                      ...
                      },
                      {
                        ...
                        "items": [
                          ...
                          },
                          {
                            "required": false,
                            "type": "radio",
                            "label": "あなたが13～17歳の間、あなたの友達がよくゲームをしているのを見たことがありますか？",
                            "options": [
                              {
                                "label": "全くあてはまらない",
                                "coding": "0"
                  ...
                  },
                  {
                    ...
                    "items": [
                      ...
                      },
                      {
                        "required": false,
                        "type": "radio",
                        "label": "あなたが13～17歳の間、あなたの家族は、あなたを公園に連れて行ってくれましたか？",
                        "options": [
                          {
                            "label": "全くあてはまらない",
                            "coding": "0"
